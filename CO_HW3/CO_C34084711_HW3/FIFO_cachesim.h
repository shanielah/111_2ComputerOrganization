...
class cache_sim_t   
{
 ...
 protected:
  ...
  uint64_t time;          // 'time' is uesd to decide the first time of block to enter the cache  
  uint64_t** enter_time;  // 'enter_time' record the first time of block to enter the cache  
